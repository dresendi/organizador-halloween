...
Los usuarios iniciales son `Adminstrador1`, `Adminstrador2` y `Adminstrador3`. Sus contrasenas estan hasheadas con PBKDF2 en el codigo; cambia estas credenciales antes de publicar en produccion.
